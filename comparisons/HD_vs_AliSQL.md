...
**HolyDuck is an independent implementation and, specifically, has no code from AliSQL or derivative projects.** They are two independent implementations in a similar problem space with fundamentally different architectures and different design goals.  
