...
### SQL Dialect
MariaDB enforces it's SQL language idioms.  You can't run SQLthat MariaDB wouldn't already allow. Put on your pirate boots though, we have [ways around that.](WRITING_SQL.md)
