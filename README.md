...
### SQL Dialect
MariaDB enforces it's SQL language idioms.  You can't run anything against DuckDB that MariaDB won't allow. Put on your pirate boots though, we have [ways around that.](WRITING_SQL.md)
