...
The full TPC-H test suite runs successfully without changes regardless of which tables are in InnoDB or DuckDB, or entirely in DuckDB, with consistently strong performance.
