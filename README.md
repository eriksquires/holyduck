...
The full TPC-H test suite runs successfully without changes even when some tables moved out of DuckDB.  Performance degrades but remains remarkably usable throughout. Aggressive caching further improves performance after waming up.
